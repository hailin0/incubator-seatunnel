...
package org.apache.seatunnel.api.table.util;
...
public class SeaTunnelDataTypeUtils {

    public static SeaTunnelRowType parseRowType(Map<String, String> fieldsMap) {
    ...
    public static SeaTunnelDataType<?> parseDataType(String type) {
        ...
        switch (sqlType) {
            ...
            default:
                return parseRowType(parseDataTypeJsonToSortedMap(originContent));
        }
    }
    ...
    public static LinkedHashMap<String, String> parseDataTypeJsonToSortedMap(String json) {
